...
public class ProtectPresetService extends Service {
    public ProtectPresetService() {
...
//        throw new UnsupportedOperationException("Not yet implemented");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("TAG", "启动获取汇率列表服务_守护进程：" + new Date().toString());
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            //断开链接
            startService(new Intent(ProtectPresetService.this, TimePresetService.class));
            //重新绑定
            bindService(new Intent(ProtectPresetService.this, TimePresetService.class),
