...
public class MarqueeTextView extends TextView {
     ...
     * 滚动方向-水平
     */
    public static final int DIRECTION_VER = 2;
    /**
     * 滚动方向-垂直
     */
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mScrollDirection = typedArray.getInt(R.styleable.MarqueeTextView_scroll_direction, DIRECTION_HOR);
